...
import { translations } from './fm-page2.translate';

@Component({
  selector: 'page-fm-page2',
  templateUrl: './fm-page2.page.html',
  styleUrls: ['./fm-page2.page.css'],
})
export class FmPage2Page implements OnInit {
  currentLang: string;
